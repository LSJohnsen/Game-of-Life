...
class Board:
    ...
    def draw(self, window):
        for row in range(self.rows):
            for column in range(self.columns):
                ...
                pygame.draw.rect(window, color, (column * self.node_size, row * self.node_size, self.node_size - 1, self.node_size - 1)) #-1 creates grids

    # randomly fill with living at initialization or keyboard (25%)
    ...
    # check bounds and toggle cell to opposite of current 
